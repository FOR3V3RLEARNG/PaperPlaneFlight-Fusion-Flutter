      ...
      body: ListView(
        ...
        children: [
          ...
          _ModeCard(
            ...
            title: 'Rival Race',
            subtitle:
                'Pick a world and wing level in the Hangar, then race an animated AI rival with debris, overtaking and powers.',
          ...
          _ModeCard(
            ...
            subtitle:
                'Two players, one phone/tablet. Landscape left/right view with independent touch steering and powers.',
            accent: FlightColors.orange,
            onTap: () => context.push(
              '/character-select',
              extra: const CharacterSelectLaunch(CharacterSelectMode.split),
            ),
          ),
          const SizedBox(height: 10),
          _ModeCard(
            ...
            subtitle:
                'Host or join a room code. Designed for two phones/tablets with low-latency state synchronization.',
            accent: FlightColors.violet,
            onTap: () => context.push(
              '/character-select',
              extra: const CharacterSelectLaunch(CharacterSelectMode.remote),
            ),
          ),
        ],
      ),
